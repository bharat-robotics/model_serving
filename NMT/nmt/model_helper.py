...
def pre_process(src_string, src_vocab_table, eos, src_max_len=35, use_char_encode=False):
...
def create_infer_model_for_export(model_creator, hparams, scope=None, extra_args=None):
